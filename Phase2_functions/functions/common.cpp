            ...
            case SCI_UINT16: //for unsigned integer 16
            {
                ...
                else
                {
                    ...
                    for(i=0;i<iRows;i++)
                    {
                        for(j=0;j<iCols;j++)
                        {
                          image.at<Vec3s>(i,j)[0]=pstDataR[k++];
                        }
                    }
                }
                break;
    ...
    else //for floating point/ double precision values
    {
        ...
        else
        {
            ...
            for(i=0;i<iRows;i++)
            {
                for(j=0;j<iCols;j++)
                {
                    image.at<Vec3d>(i,j)[0]=pstDataR[k++];
                }
            }
        }
    }
...
int returnImage(char *checker,Mat img,int pos)
{
    ...
    if(strcmp(checker,"CV_8U")) //for Unsigned Integer 8
    {
        if(num==3)
        {
        ...
        else
        {
            ...
            for(i=0;i<img.rows;i++)
            {
                for(j=0;j<img.cols;j++)
                {
                    ...
                    *(r + i*img.cols + j)=intensity.val[0];
                }
            }
    ...
    else if(strcmp(checker,"CV_16U")) //for Unsigned Integer 16
    {
        if(num==3)
        {
            //Since we need to pass a single pointer as an arguement, for a 2-D matrix, we define it in this manner
    ...
    else if(strcmp(checker,"CV_16S")) //for Signed Integer 16
    {
        if(num==3)
        {
            //Since we need to pass a single pointer as an arguement, for a 2-D matrix, we define it in this manner
    ...
    else if(strcmp(checker,"CV_32F")) //for Float 32
    {
        if(num==3)
        {
            //Since we need to pass a single pointer as an arguement, for a 2-D matrix, we define it in this manner
    ...
    else if(strcmp(checker,"CV_64F")) //For Float 64
    {
        if(num==3)
        {
            //Since we need to pass a single pointer as an arguement, for a 2-D matrix, we define it in this manner
